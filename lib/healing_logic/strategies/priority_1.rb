module Strategies
  class Priority1 < ProfitCalculator
    ...
    def target(healer, patient)
      (patient == healer) ? Spells::Target::SELF : Spells::Target::OTHER
    end
    ...
    def post_heal_magicka spell
      stat_percentage(:magicka, @healer, spell).post_heal
    end
  end
end
